...
public class SearchPermutation {
  ...
  /**
   * Возвращает hash списка символов. Недостатком этого является то, что хеш для {"x", "x"} такой
   * же, как хеш для {"y", "y"}. Не подошёл, слишком большая коллизия.
   */
  ...
  /**
   * Возвращает hash списка символов. Есть проблемы для {1, -1} и {2, -2}, но если используются
   * строки это не проблема. Не подошёл слишком большая коллизия.
   */
