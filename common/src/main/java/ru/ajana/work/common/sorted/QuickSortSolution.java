...
/**
 * 5. Суть данного алгоритма заключается в том, что в списке с элементами выбирается опорный элемент —
 * по сути любой элемент, относительно которого нужно отсортировать остальные значения. Значения
 * меньше его — слева, значения больше — справа.
 *
...
public class QuickSortSolution {
  ...
  public static void recursionFastSort(int[] array, int min, int max) {
    ...
    int i = min, j = max;
    // относительно элемента middle определяем меньшие элементы слева, большие справа
    while (i <= j) {
